...
print(f'Output for row 2: {get_index_first_non_zero_value_from_row(N, 2, augmented = False)}')
print(f'Output for row 3: {get_index_first_non_zero_value_from_row(N, 3, augmented = False)}')
